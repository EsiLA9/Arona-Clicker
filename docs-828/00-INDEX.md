...
| Datapack 读取 / 多包管理 / mod 冲突 | [[0x-plan&work/active/adr-0004-datapack-management]] |
...
> 原 `06-adr/` 与 `08-roadmap/` 已聚合至 [[0x-plan&work/00-index]]；以下保留主题路由，正文统一维护在 `0x-plan&work/`。

| 文档 | 决策 |
| --- | --- |
| [[0x-plan&work/completed/adr-0001-architecture-consolidation]] | T1-T7 架构整理收官（装配外移 / 只读纪律 / 表驱动 / 环解扣） |
| [[0x-plan&work/completed/adr-0002-gamenum-tree]] | GameNum 四级层级树 + 事件驱动失效（taskProduction Phase 1-8） |
| [[0x-plan&work/completed/adr-0003-docs-restructure]] | 文档库重构：从日期戳手册到分层索引 |
| [[0x-plan&work/active/adr-0004-datapack-management]] | Datapack 多包读取与管理（三段式命名空间 / 包库与启用集 / 惰性存档；规划中） |
| [[0x-plan&work/completed/affection-planning]] | 好感系统设计（§1 数值 / §2 台阶推送与未读 / §3 羁绊尾巴挂靠推送；§4 Talklet 输入中提示未实现；2026-08-29 落地，轴 A 消息成分同日裁定移除） |
...
| 编号 | 目标 | 状态 |
| --- | --- | --- |
| [[0x-plan&work/active/roadmap-0001-datapack-management]] | Datapack 多包管理落地（S1-S7） | 进行中（S1a/S1b 已落地） |
| [[0x-plan&work/active/roadmap-0002-spot-shop]] | Spot 商店（购买集 / 发现限制） | 待设计裁定 |
| [[0x-plan&work/active/roadmap-0003-gacha-pool-model]] | 卡池模型规范化（banner ↔ 角色池解耦） | 待设计裁定 |
| [[0x-plan&work/active/roadmap-0004-chara-ownership]] | Chara 拥有体系 Init 化 + 追赶统计 | 待设计裁定 |
| [[0x-plan&work/completed/roadmap-0005-engine-domain-consolidation]] | 基础引擎、基础数据服务与 AronaClicker 领域内聚 | ✅ 已完成（2026-09-02） |
