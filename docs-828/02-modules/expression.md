...
> 一句话：`src/engine/expression/` 承担声明式数据包的**求值**——数值表达式、条件、Funclet、统计 DSL（产出树 GameNum 单列 [[docs-828/02-modules/game-num]]）。
...
- 全枚举目录见 [[docs-828/03-data-structures/declarative-dsl]]。
...
[[docs-828/02-modules/game-num]] · [[docs-828/03-data-structures/declarative-dsl]]
