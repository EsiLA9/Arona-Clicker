...
> ⚠️ **已归档（2026-08-28）**：本库为历史快照，不再维护，正文保留原样。内容与代码存在漂移（T1-T7 架构整理、生产树重构等变动后未回写），**请勿以此为准**。
> 现行文档库：[[docs-828/00-INDEX]]（以 2026-08-28 代码实况逐篇核对重写）。迁移对照见 [[docs-828/06-adr/0003-docs-828-restructure]]。
