# 建立 docs-828/08-roadmap 分区（长期目标/路线图）
...
### 5. 更新 `AGENTS.md`
- 快速上手路由表加一行：长期目标 / roadmap / 里程碑进度 → [[docs-828/08-roadmap/00-overview]]。
