...
| 好感系统（数值 / 台阶推送 / 羁绊尾巴 / 输入中提示）机制 | [[docs/0x-plan&work/completed/affection-planning]]（机制单一事实源；聊天消息成分已移除） |
| Datapack 读取 / 多包管理 / mod 冲突与命名空间 | [[docs/0x-plan&work/active/adr-0004-datapack-management]]（规划中，裁定记录见文内） |
