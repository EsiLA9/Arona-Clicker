...
**相关任务**：[[docs/plan-work/active/adr-0010-definition-repository-editor-resolution]]、[[docs/plan-work/active/task-0057-single-mod-editor-workbench]]
...
- [[docs/plan-work/active/adr-0011-definition-resolution-withdrawal]]：解析状态、编辑操作、Draft-only Tombstone 与 Delta / Runtime 失效责任边界。
