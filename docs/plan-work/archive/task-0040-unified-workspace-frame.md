...
状态：active — 施工中（F0-F4 已完成；F5-F7 的 Contacts / Story 相关部分由 Task-0047 优先收口，其余通用 Router / 视觉 / Host 清理仍待后续）
...
- [[task-0047-contacts-story-workspace-ownership]]：F5–F7 中与 Contacts / Story 路由、Host 和响应式契约相关的优先后续施工。
