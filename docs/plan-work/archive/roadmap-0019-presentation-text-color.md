...
> 状态：done — 已完成（2026-09-05）。本文记录文字颜色控制的施工范围与验收结果；表现层机制以源码与 `docs/docs-828` 为准。
...
- [[roadmap-0017-theme-state-and-semantic-storage]]
- [[roadmap-0018-button-state-unification]]
