...
- **决策者**：项目维护者 + AI 协作
- **来源**：项目结构探索与后续内聚任务设计
- **关联 Roadmap**：[[roadmap-0005-engine-domain-consolidation]]
...
- 与 [[roadmap-0001-datapack-management]] 的多包管理工作存在交叉，需要按本 ADR 更新 base 语义。
...
- 后续实现进度记录在 [[roadmap-0005-engine-domain-consolidation]]；设计变更只更新本 ADR。
