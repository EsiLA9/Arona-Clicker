...
> **关联**：[[adr-0004-datapack-management]]（多包与命名空间权威）、[[roadmap-0001-datapack-management]]（切片状态）、[[docs/docs-828/05-conventions/schema-sync]]（Schema 同步协议）、[[docs/docs-828/07-audit/sync-burden]]（双载体问题）。
