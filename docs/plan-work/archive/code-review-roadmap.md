...
- [ ] 复核多包目标中 S1c–S7 的实现状态，见 [[roadmap-0001-datapack-management]]；
...
- [x] 记录 Affector → ConditionDepIndex → GameNum/flow → Tick 性能审查判别，见 [[task-0034-affector-performance-review]]；
...
- [ ] 与未完成的卡池模型、角色拥有体系对照复核：[[roadmap-0003-gacha-pool-model]]、[[roadmap-0004-chara-ownership]]。
...
- [x] 核验条件展示从字符串化到 Presentation Tree 的建议，见 [[task-0035-condition-presentation-tree]]；
...
- [ ] Review 发现中需要长期跟踪的事项已转入 `docs/plan-work/archive/` 的主题文件。
