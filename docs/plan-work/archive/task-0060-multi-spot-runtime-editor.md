...
**日期**：2026-09-14  
**前置**：[[task-0055-runtime-datapack-editor-mvp]]、[[task-0056-workspace-datapack-boundary-convergence]]、[[task-0058-definition-resolution-p1a]]、[[task-0059-definition-resolution-p1b]]  
**关联任务**：[[task-0057-single-mod-editor-workbench]]  
**关联裁定**：[[adr-0010-definition-repository-editor-resolution]]、[[adr-0011-definition-resolution-withdrawal]]
...
- [[task-0055-runtime-datapack-editor-mvp]]：单 Mod / 单临时 Spot Runtime 编辑基线；
- [[task-0057-single-mod-editor-workbench]]：单 Mod 全内容编辑工作台的长期目标；
- [[task-0058-definition-resolution-p1a]]：来源解析、Tombstone、三态结果与 Delta；
- [[task-0059-definition-resolution-p1b]]：引用策略、诊断与 DefinitionChange 消费；
- [[adr-0010-definition-repository-editor-resolution]]：Editor 来源解析与 Runtime Registry 边界；
- [[adr-0011-definition-resolution-withdrawal]]：撤回、悬置和 Draft-only Tombstone 语义；
