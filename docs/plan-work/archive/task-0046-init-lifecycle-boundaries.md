...
状态：closing — P0/P1 已完成；P2 延期

关联裁定：[[adr-0009-init-lifecycle-boundaries]]
...
PassiveStory 的 `passiveCooldowns` / `studentBlocks` 快照归属和 completion 幂等已由 [[task-0032-passive-story-scheduling]] 负责，本任务不重复改写其业务规则。
...
| 既有相关任务 | PassiveStory per-Init cooldown/block 与完成幂等已有独立施工任务 | `docs/plan-work/archive/task-0032-passive-story-scheduling.md` |
...
- [[adr-0009-init-lifecycle-boundaries]]
- [[task-0032-passive-story-scheduling]]
- [[adr-0007-shop-transaction-boundaries]]
