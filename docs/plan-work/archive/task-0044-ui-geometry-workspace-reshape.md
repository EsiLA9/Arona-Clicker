...
状态：done — 已完成（P0–P7 已实施并通过自动化、Chrome/CDP 与工程门禁；CUA 连接故障不影响浏览器证据）

上游：[[12-ui-geometry-workspace-reshape]]（本地化结构重塑草案）

依赖：[[task-0040-unified-workspace-frame]]、[[task-0042-character-workspace-ui-convergence]]、[[task-0043-topbar-settings-workspace]]、[[10-inventory-workspace]]
...
- [[12-ui-geometry-workspace-reshape]]
