...
> 状态：active — 第一阶段已落地，后续实现中（2026-09-06 核验）
>
> 范围：颜色组、颜色装备、主题设计、Area / CharacterVariant 声明主题、运行时主题层、用户自定义主题，以及 Affector 提供的主题编辑能力。

> 设计原则：收敛“解析方式”，不强行收敛“内容来源”。主题系统应允许数据包扩展和玩家创作，但任何来源都必须能够被识别、继承、预览和撤销。全局来源单选与用户主题应用边界由 [[task-0027-theme-switch-cleanup-and-user-theme-isolation]] 进一步收束。
