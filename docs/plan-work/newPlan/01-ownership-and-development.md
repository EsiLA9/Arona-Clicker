...
> 修订注记（2026-09-11）：好感归属经 [[docs/plan-work/active/adr-0008-character-progression-boundaries]] 裁定为 **Variant 级 + Proto 求和**，本文「关系状态分层」中『Character Affection：好感属于人、跨 Variant 共享』的口径已作废。
