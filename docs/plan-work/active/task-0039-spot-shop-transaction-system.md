...
设计草案：[[docs/plan-work/newPlan/09-shop-transaction-draft]]  
上游路线：[[docs/plan-work/active/roadmap-0002-spot-shop]]
上游意见审阅：[[docs/plan-work/active/task-0039-sol-review]]
...
- [x] 将 C0–C5 及 C1-a 写入正式 ADR；未裁定项不得通过“先写类型、后补语义”绕过。见 [[docs/plan-work/active/adr-0007-shop-transaction-boundaries]]。
...
- [[docs/docs-828/05-conventions/schema-sync]]
- [[docs/docs-828/05-conventions/testing]]
- [[docs/plan-work/newPlan/09-shop-transaction-draft]]
