...
**日期**：2026-09-14  
**前置**：[[docs/plan-work/active/task-0055-runtime-datapack-editor-mvp]]、[[docs/plan-work/active/task-0056-workspace-datapack-boundary-convergence]]、[[docs/plan-work/active/adr-0010-definition-repository-editor-resolution]]、[[docs/plan-work/active/adr-0011-definition-resolution-withdrawal]]
...
当前进度：Definition Resolution 的 P1A 纯模型已由 [[docs/plan-work/active/task-0058-definition-resolution-p1a]] 实施并验证；Task-0057 的 Draft 工作区、全表 UI、Runtime Preview 与 Mod Export 仍未施工。
...
- [[docs/plan-work/active/task-0055-runtime-datapack-editor-mvp]]：当前单 Mod / 临时 Spot Overlay 基线；
- [[docs/plan-work/active/task-0056-workspace-datapack-boundary-convergence]]：Workspace、UI 状态和查询边界；
- [[docs/plan-work/active/adr-0010-definition-repository-editor-resolution]]：DefinitionRepository 与来源解析顺序；
- [[docs/plan-work/active/adr-0011-definition-resolution-withdrawal]]：Definition Resolution 撤回、引用悬置与 Draft-only Tombstone 语义；
- [[docs/plan-work/active/adr-0004-datapack-management]]：Source、Pack、PackManager、启用集和存档残留；
