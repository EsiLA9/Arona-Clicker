...
状态：🟡 代码与测试已完成；Edge 视觉验收待补（当前环境无法取得浏览器状态）

> 本文承接 [[docs/plan-work/active/task-0051-user-theme-layer-editor-functional-recovery]]。Task0051 解决了浮层"存在但不可操作"的功能阻断；本任务处理其表现层：样式类名漂移、控件尺寸、浮层拖拽与 LayerManager 行内信息常显。
>
