...
关联裁定：[[docs/plan-work/active/adr-0009-init-lifecycle-boundaries]]
...
PassiveStory 的 `passiveCooldowns` / `studentBlocks` 快照归属和 completion 幂等已由 [[docs/plan-work/active/task-0032-passive-story-scheduling]] 负责，本任务不重复改写其业务规则。
...
| 既有相关任务 | PassiveStory per-Init cooldown/block 与完成幂等已有独立施工任务 | `docs/plan-work/active/task-0032-passive-story-scheduling.md` |
...
- [[docs/plan-work/active/adr-0009-init-lifecycle-boundaries]]
- [[docs/plan-work/active/task-0032-passive-story-scheduling]]
