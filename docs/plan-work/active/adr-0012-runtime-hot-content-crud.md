...
**日期**：2026-09-14  
**依据**：[[docs/plan-work/active/task-0060-multi-spot-runtime-editor]]、当前 Runtime / Registry 代码核查  
**关联**：[[docs/plan-work/active/adr-0010-definition-repository-editor-resolution]]、[[docs/plan-work/active/adr-0011-definition-resolution-withdrawal]]、[[docs/plan-work/active/task-0061-runtime-hot-content-crud-spot]]
...
实现拆分见 [[docs/plan-work/active/task-0061-runtime-hot-content-crud-spot]]：
