...
> 设计原则：收敛“解析方式”，不强行收敛“内容来源”。主题系统应允许数据包扩展和玩家创作，但任何来源都必须能够被识别、继承、预览和撤销。全局来源单选与用户主题应用边界由 [[docs/plan-work/active/task-0027-theme-switch-cleanup-and-user-theme-isolation]] 进一步收束。
