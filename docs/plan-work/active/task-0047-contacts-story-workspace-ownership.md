...
> 本任务把 [[docs/plan-work/newPlan/14-contacts-story-workspace-ownership]] 的源码核验与设计草案转为可执行施工任务。它只处理 Workspace 所有权、路由、状态归属、Host 注册和刷新边界，不把通讯录 / 故事的最终内容信息架构伪装成已裁定方案。
...
- [[docs/plan-work/newPlan/14-contacts-story-workspace-ownership]]
...
| --- | --- | --- | --- | --- |
| WS-P0 | [[docs/plan-work/active/task-0040-unified-workspace-frame]] | F0–F4 已完成主要 Frame / Column 接线 | F5 Router 状态、F6 响应式 / 视觉清理、F7 Host Registry 收尾中与 Contacts / Story 相关的部分 | Contacts / Story 施工前优先收口 |
