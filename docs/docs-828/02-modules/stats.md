...
- **统计函数 30+**（`$GlobalProducedAmount` 等）经 `stat-dsl.ts` 映射到三层桶指标；条件系统 `stat` target 引用（见 [[docs/docs-828/03-data-structures/stats-views]]）。
...
[[docs/docs-828/03-data-structures/stats-views]] · [[docs/docs-828/02-modules/expression]]（stat-dsl）
