...
- **不管**：临时演出主题层（`RuntimeThemeManager`，见 [[docs/docs-828/02-modules/core]]）。
...
- 主题分层与合并规则见 [[docs/docs-828/04-mechanisms/color-derivation]]。
...
[[docs/docs-828/04-mechanisms/color-derivation]] · [[docs/docs-828/02-modules/ui]]（theme-tree 落 CSS 变量）
