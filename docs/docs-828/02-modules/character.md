...
- **不管**：色彩（[[docs/docs-828/02-modules/color]]）、剧情与聊天（[[docs/docs-828/02-modules/story]]）。
...
- **原型与差分**：`CharacterDef` 是「全集」概念（收集/分组按原型）；`CharacterVariantDef` 是具体差分（独立实体，带 name/rarity 副本，`proto` 仅作聚合键——意义引用）。实体结构见 [[docs/docs-828/03-data-structures/character-entities]]。
...
- 结算细节：抽卡 [[docs/docs-828/04-mechanisms/gacha]]、培养 [[docs/docs-828/04-mechanisms/cultivate]]、通讯录 [[docs/docs-828/04-mechanisms/roster]]。
...
[[docs/docs-828/03-data-structures/character-entities]] · [[docs/docs-828/02-modules/color]]
