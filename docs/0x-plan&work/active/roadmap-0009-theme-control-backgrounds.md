...
> 本文规划主题编辑器对按钮、Tab、开关、输入框等 UI 控件背景的支持。主题色节点与作用域继承沿用 [[docs/0x-plan&work/active/roadmap-0008-theme-color-system-refactor]]；页面、面板和区域背景层沿用 [[docs/0x-plan&work/active/roadmap-0006-ui-background-layering]]。
