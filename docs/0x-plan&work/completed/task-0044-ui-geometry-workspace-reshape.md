...
上游：[[docs/0x-plan&work/newPlan/12-ui-geometry-workspace-reshape]]（本地化结构重塑草案）

依赖：[[docs/0x-plan&work/active/task-0040-unified-workspace-frame]]、[[docs/0x-plan&work/active/task-0042-character-workspace-ui-convergence]]、[[docs/0x-plan&work/active/task-0043-topbar-settings-workspace]]、[[docs/0x-plan&work/newPlan/10-inventory-workspace]]
...
| P7.1 | 更新 UI 模块事实文档、Task 状态、索引和相关机制聚合链接 | `docs/docs-828/02-modules/ui.md`、`docs/0x-plan&work/00-index.md` | 文档同步 | ✅ UI 事实、Task/索引均已同步 |
...
- [[docs/0x-plan&work/newPlan/12-ui-geometry-workspace-reshape]]
