...
export const EVENT_CATALOG: Record<GameEvent['type'], EventCatalogEntry> = {
  ...
  themeChanged: { purpose: '主题切换', emit: ['state-mutation-service'], subscribe: [] }, entityThemeChanged: { purpose: '实体主题变化', emit: ['state-mutation-service'], subscribe: [] }, entityDesignUnlocked: { purpose: '实体配色设计解锁', emit: ['state-mutation-service'], subscribe: [] },
