...
export const baseSpots: SpotDef[] = [
  ...
  spot('base:spot:abydos_cafe', 'base:area:abydos_campus').name('阿比多斯咖啡角').desc('临时搭起的咖啡角。午后的阳光里，少女们的谈笑声此起彼伏。').cost(15).yield(6).capacity(300).managerBonus(3).tags(tagPath('shop'), tagPath('rest')).shop('base:funclet:abydos_cafe_shop', 'base:shop:abydos-cafe').revealResource('name', Resource.Credit, 8).revealResource('utility', Resource.Credit, 30).levelUpTo(3).genericUpgrade(70, 1.8, 1).build(),
