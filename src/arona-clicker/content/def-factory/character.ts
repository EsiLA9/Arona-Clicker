...
export class CharacterBuilder {
  ...
  build(): CharacterData {
    ...
    const def: CharacterData = { id: this._id, name: this._name, displayName: this._displayName, school: this._school, rarity: this._rarity, description: this._description };
