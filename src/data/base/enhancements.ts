...
export const baseEnhancements: EnhancementDef[] = [
  enhancement('base:enhancement:credit_system')
  ...
  enhancement('base:enhancement:office_layout')
  ...
  enhancement('base:enhancement:field_logistics')
    .name('野外后勤协议')
  ...
  enhancement('base:enhancement:combat_drone')
  ...
  enhancement('base:enhancement:field_medicine')
    .name('战地医疗').desc('活化（医疗）加成，医疗站恢复量提升。')
    .tags(['field'], ['field', 'medical'])
    .cost(CREDIT, 180)
    .build(),

  enhancement('base:enhancement:intel_network')
    .name('情报网络').desc('情报处理效率提升。')
    .tags(['intel'], ['intel', 'network'])
    .cost(CREDIT, 160)
    .build(),

  enhancement('base:enhancement:training_program')
    .name('训练计划').desc('人员效率提升。')
    .tags(['core'])
    .cost(CREDIT, 120)
    .build(),

  enhancement('base:enhancement:medical_station')
    .name('医疗站扩建').desc('医疗站产能提升。')
    .tags(['field'], ['field', 'medical'])
    .cost(CREDIT, 180)
    .build(),

  enhancement('base:enhancement:rapid_deployment')
    .name('快速部署').desc('部署速度提升。')
    .tags(['field'])
    .cost(CREDIT, 140)
    .build(),

  enhancement('base:enhancement:area_hub')
    .name('区域枢纽').desc('区域中转效率提升。')
    .tags(['area'])
    .cost(CREDIT, 220)
    .build(),

  enhancement('base:enhancement:research_grant')
  ...
  enhancement('base:enhancement:investment_fund')
  ...
  enhancement('base:enhancement:pyroxene_rush')
  ...
  enhancement('base:enhancement:tactical_command')
  ...
  enhancement('base:enhancement:supply_chain')
  ...
  enhancement('base:enhancement:energy_supply')
    .name('能源供给').desc('全局产出 ×1.25；并额外 +1 信用点/分钟。')
    .tags(['core'])
    .affectorPacks('base:affectorpack:energy_drink', 'base:affectorpack:energy_supply_mult')
    .cost(CREDIT, 150)
    .build(),

  enhancement('base:enhancement:sanctuary_field')
  ...
  enhancement('base:enhancement:test_pyroxene_cheat')
...
export const baseGlobalEnhancements: EnhancementDef[] = [
  enhancement('base:enhancement:foundation')
  ...
  enhancement('base:enhancement:unified_logistics')
  ...
  enhancement('base:enhancement:eternal_contract')
