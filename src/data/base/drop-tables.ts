...
export const baseDropTables: DropTableDef[] = [
  dropTable('base:droptable:basic_field_reward')
    .maxRolls(1)
    .guaranteed('base:item:field_note', 1)
    .entry('base:item:energy_drink', 1, 1, 1)
    .build(),
  dropTable('base:droptable:trinity_daily')
    .maxRolls(2)
    .guaranteed('base:item:field_note', 1)
    ...
    .build(),
  dropTable('base:droptable:gehenna_daily')
    .maxRolls(2)
    ...
    .build(),
  dropTable('base:droptable:millennium_research')
    .maxRolls(3)
    ...
    .build(),
  dropTable('base:droptable:abydos_field')
    .maxRolls(2)
