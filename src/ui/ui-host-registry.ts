...
const CORE_HOSTS: readonly UIHostDefinition[] = [
  ...
  { id: 'leftPanel.tabs', label: '左侧栏 · Tab 区域', level: 'region', parent: 'leftPanel', kind: 'container' },
  ...
  { id: 'centerPanel.tabs', label: '中部栏 · Tab 区域', level: 'region', parent: 'centerPanel', kind: 'container' },
  ...
  { id: 'rightPanel.tabs', label: '右侧栏 · Tab 区域', level: 'region', parent: 'rightPanel', kind: 'container' },
