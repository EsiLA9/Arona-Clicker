...
export function ensureUserThemeLayerOverlay(ctx: UIContext, sessionId: string, draft: UserThemeDraft, active: boolean, initialTarget: ThemeLayerTargetRef | null = null): HTMLElement {
