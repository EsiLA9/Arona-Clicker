// ============================================================
// engine/def-factory/character.ts — CharacterData 链式 Builder
// ============================================================
...
import type { CharacterData } from '../types/common';
...
export class CharacterBuilder {
  ...
  /** 对指定标签 Spot 的产出加成倍率（1.0 = 无加成）。 */
  bonus(tag: string, multiplier: number): this {
    this._spotTagBonus[tag] = multiplier;
    return this;
  }
  ...
  build(): CharacterData {
    ...
    const def: CharacterData = {
      ...
      spotTagBonus: this._spotTagBonus,
      passiveDescription: this._passiveDescription,
    };
