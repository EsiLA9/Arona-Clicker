// ============================================================
// engine/def-factory/enhancement.ts — Enhancement 定义链式 Builder
// 构造 EnhancementDef。.build() 返回标准 EnhancementDef。
// ============================================================
...
import type { AreaId, EnhancementId, InitId } from '../types/ids';
import type { RevealTarget, RevealTrigger } from '../types/reveal';
import type { ResourceAmount } from '../types/common';
import type { AffectorPackRef } from '../types/trigger';
import type { EnhancementAttachment, EnhancementDef } from '../types/content';
import type { SpotFunctionalityDef } from '../types/world';
