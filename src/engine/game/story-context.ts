// ============================================================
// engine/game/story-context.ts — 剧情运行时共享上下文
...
import type { StateMutationService } from '../system/state-mutation-service';
import type { PassivePoolSystem } from '../system/passive-pool-system';
