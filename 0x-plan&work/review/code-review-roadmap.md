...
- `AGENTS.md`；
- `docs-828/00-INDEX.md`；
- `docs-828/01-architecture/overview.md`；
- `docs-828/01-architecture/run-logic.md`；
- `abstract.md`。
...
- [ ] 复核多包目标中 S1c–S7 的实现状态，见 [[0x-plan&work/active/roadmap-0001-datapack-management]]；
...
- [ ] 复核 `docs-828/07-audit/` 中 GameNum/Affector 豁免是否仍合理；
...
- [ ] 与未完成的卡池模型、角色拥有体系对照复核：[[0x-plan&work/active/roadmap-0003-gacha-pool-model]]、[[0x-plan&work/active/roadmap-0004-chara-ownership]]。
...
| 2026-09-02 | 文档计划层 | 原 ADR/Roadmap/Plan 分散在 root 与 `docs-828/06-adr`、`08-roadmap` | ✅ 已聚合至 `0x-plan&work/` |
| 2026-09-02 | 当前 Review 文档 | 旧路线使用已删除的 `src/engine/game`、`src/engine/registry` 等路径 | ✅ 已按当前源码重写本文件 |

## 相关入口

- [[0x-plan&work/00-index]]
- [[docs-828/00-INDEX]]
