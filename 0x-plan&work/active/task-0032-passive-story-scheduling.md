...
关联方案：[[0x-plan&work/newPlan/08-passive-story-sol-review]]
...
6. 若新增/修改 Datapack 字段进入编辑器 Schema，按 [[docs-828/05-conventions/schema-sync]] 完成生成与同步检查。
...
- 已核对 `docs-828/00-INDEX`、架构纪律、测试规范和文档维护规范；
