...
状态：✅ 已裁定；施工任务见 [[0x-plan&work/active/task-0032-passive-story-scheduling]]

> 本文保存 Sol 对 PassiveStory 的完整设计意见，并基于当前 AronaClicker 代码逐条审阅。本文是方案评审记录，不替代 docs-828 中的当前机制事实源，也不代表已经决定引入 StoryChain。
...
用户裁定执行 P0、P1，并将 Pool 分层权重从原 P2 提前纳入当前任务。具体施工范围与验收标准见 [[0x-plan&work/active/task-0032-passive-story-scheduling]]。
...
- 当前好感/尾巴方案：0x-plan&work/completed/affection-planning.md
