      ...
      spots: [
        {
          ...
          name: 'T',
          description: 'd',
          purchaseOptions: [{ id: 'purchase', costs: [{ type: 'resource', resourceId: 'base:resource:credit', amount: { type: 'const', value: 1 } }] }],
          functionalities: [{ id: 'base:flow:test', kind: 'flow', resource: 'base:resource:credit', amount: 1 }],
